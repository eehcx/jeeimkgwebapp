...
urlpatterns = [
    ...
    path('inbox/delete/<str:pre_customer_id>/', views.deletePreCustomer, name='deletePreCustomer'),
    ...
    path('clients/delete/<str:customer_id>/', views.deleteCustomer, name='deleteCustomer'),
